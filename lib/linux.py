...
"""
Linux libs used to created encrypted shellcode ELF file executable dropper.
"""
...
class packer():
  """
  Paker class used to package shellcode into an encrypted executable. 
  """
  def __init__(self, random, password):
    self.random = random
